...
const Hero = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (user && user.password === password) {
        ...
        setAdminName(`${user.firstName} ${user.lastName}`); // Set admin name
  ...
  const handleSignUpSubmit = async (e) => {
    ...
    try {
      const newUser = { firstName, lastName, email, password, mobileNumber };
  ...
  return (
    <section className="bg-transparent bg-red-300 m-0 p-0 h-60 ">
      <nav className="absolute top-0 left-0 right-0 flex bg-white  h-24 justify-between items-center p-4 z-10">
        ...
        <div className="flex gap-4 ml-4">
          ...
          <a href="#">
            <div
              className="flex items-center bg-white rounded-xl px-1 py-2 cursor-pointer"
              onClick={handleUserClick}
            >
              {adminName && <span className="mr-2">{adminName}</span>} {/* Display admin name */}
